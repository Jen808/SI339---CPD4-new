...
<link rel="stylesheet" href="css/meet-style.css">
<script src="script.js"></script>
   ...
   <body>
    ...
    <nav id="inner-sec">
        <ul>
            <li class="inner-li"><a href="#summary" tabindex="0">Summary</a></li>
            <li class="inner-li"><a href="#team-results" tabindex="0">Team Results</a></li>
            <li class="inner-li"><a href="#individual-results" tabindex="0">Individual Results</a></li>
            <li class="inner-li"><a href="#gallery" tabindex="0">Gallery</a></li>
        </ul>
    </nav>
...
"""
        ...
        for row in rows[4:]:
            ...
            if len(row) == 3:
                if row[0] == "Place":
                    html_content += f"<tr tabindex='0'><th>{row[0]}</th><th>{row[1]}</th><th>{row[2]}</th></tr>\n"
...
<figure> 
    ...
    <img src="../images/profiles/{profile_pic}" width="200" alt="Profile picture of {name}" onerror="this.onerror=null; this.src='../images/profiles/default_image.jpg';"> 
</figure>
<dl>
...
def generate_image_tags(image_files, folder_path):
    ...
    for img in image_files:
        ...
        img_tags.append(f'<img src="../{img_path}" width="200" alt="" onerror="this.onerror=null; this.src=\'../images/profiles/default_image.jpg\';">')
    return "\n".join(img_tags)
